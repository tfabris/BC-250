...
Ensure that your computer has Python 3 installed, then install PlatformIO using their `get-platformio.py` installer script. Follow their instructions here:
